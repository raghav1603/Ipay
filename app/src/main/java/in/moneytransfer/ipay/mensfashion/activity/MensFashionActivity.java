package in.moneytransfer.ipay.mensfashion.activity;
...
import in.moneytransfer.ipay.mensfashion.constants.MensFashionConstants;
...
public class MensFashionActivity extends AppCompatActivity implements OnOffersClickListener,OnBuyAddCartClickListener,DataProgressListener {
    ...
    private void createUI()
    {
        ...
        dataRetriever = new DataRetriever(this,this, MensFashionConstants.MENS_FASHION_DATABASE_REFERENCE);
